...
class AnswerSubmission(BaseModel):
    ...
    question_id: str
    selected_value_codes: List[str] = Field(default_factory=list, description="For single/multi select questions.")
    free_text: Optional[str] = Field(None, description="For free_text or clarification input.")
